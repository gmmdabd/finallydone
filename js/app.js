            ...
            <div class="container">
                <div class="upload-container">
                    ...
                    <form id="upload-form">
                        ...
                        <button type="submit" class="btn btn-block"><i class="fas fa-upload"></i> <span class="nav-text">Upload Note</span></button>
                    </form>
                </div>
            </div>
        `;
                ...
                <div class="community-container">
                    ...
                    <div class="post-form">
                        ...
                        <form id="post-form">
                            ...
                            <button type="submit" class="btn"><i class="fas fa-paper-plane"></i> <span class="nav-text">Post</span></button>
                        </form>
                    </div>
                                    ...
                                    <div class="post-replies" id="replies-${post.id}" style="display: none;">
                                        ...
                                        <div class="reply-form" id="reply-form-${post.id}">
                                            <form class="post-reply-form" data-post-id="${post.id}">
                                                ...
                                                <button type="submit" class="btn"><i class="fas fa-paper-plane"></i> <span class="nav-text">Submit Reply</span></button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
